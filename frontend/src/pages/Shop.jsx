                ...
                <div key={c._id} className="mb-2">
                  <div className="flex ietms-center mr-4">
                    <input
                      ...
                      className="w-4 h-4 bg-gray-100 border-gray-300 rounded focus:ring-red-500 dark:focus:ring-red-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                    />
