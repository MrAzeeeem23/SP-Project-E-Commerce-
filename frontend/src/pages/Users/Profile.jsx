...
const Profile = () => {
  ...
  return (
    <div className="container mx-auto p-4 mb-[10rem]">
      <h1 className="text-[4rem] mb-4 capitalize tracking-[-5px] font-[999]">
        Profile.
      </h1>
            ...
            <div className="mb-4">
              ...
              <label className="block bg-slate-900 p-4 text-white mb-2 cursor-pointer text-center rounded-xl transition-all hover:bg-slate-700">
                ...
                <input
                  ...
                  name="avatar"
                  className="hidden form-input p-4 rounded-2xl w-full bg-slate-500"
                  accept="image/*"
            ...
            <div>
              <div className="mb-4">
                ...
                <input
                  ...
                  className="form-input p-4 rounded-2xl w-full"
                  value={username}
